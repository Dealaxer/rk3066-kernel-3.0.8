...
extern void zet6221_ts_charger_mode_disable();
extern void zet6221_ts_charger_mode();

static u8 ChargeChange = 0;
extern int probe_finished;

void Set_ChargeChange_value(int temp_value )
{   
	ChargeChange=temp_value;
}

EXPORT_SYMBOL_GPL(Set_ChargeChange_value);
#endif
