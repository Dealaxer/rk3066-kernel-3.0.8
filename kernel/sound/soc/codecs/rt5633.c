...
static struct rt5633_init_reg init_list[] = {
	...
	{RT5633_HP_OUT_VOL 		, 0xc1c1},//HP output volume is 0 db by default
...
///////////////////////////////////////////////////////////////////////////////
// read gpio statue from ic
//////////////////////////////////////////////////////////////////////////////
int codec_read_hp_state()
{
  struct snd_soc_codec *codec = rt5633_codec;
  int ret = 0;
  ret = !((rt5633_read(codec, 0x4a)) & 0x10);
  printk("%s: %d\n", __func__, ret);
  return ret;
}
EXPORT_SYMBOL(codec_read_hp_state);
